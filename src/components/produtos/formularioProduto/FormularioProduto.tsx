  ...
  return (
    <div className="container flex flex-col mx-auto items-center">
      ...
      <form onSubmit={gerarNovoProduto} className="flex flex-col w-1/2 gap-4">
        ...
        <button disabled={carregandoCategoria} type='submit' className='rounded disabled:bg-slate-200  bg-all-azul-7 text-white hover:text-all-azul-7 hover:bg-all-cinza-7 font-brunoace w-1/2 mx-auto block py-2'>
