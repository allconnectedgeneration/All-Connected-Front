  ...
  return (
    <div className='container w-1/3 mx-auto'>
      ...
      <div className='border flex flex-col rounded-2xl overflow-hidden justify-between'>
        <header className='py-2 px-6 bg-all-azul-7 text-white font-bold text-2xl'>Produto</header>
        <div className="p-4">
        ...
        <div className="flex">
          ...
          <button className='w-full bg-all-azul-7 text-white hover:text-all-azul-7 hover:bg-all-cinza-7 font-brunoace flex items-center justify-center' onClick={deletarProduto}>
            Sim
          </button>
        </div>
      </div>
